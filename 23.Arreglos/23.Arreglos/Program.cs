namespace _23.Arreglos
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine($"Ingrese el nombre para posicion {i + 1}, con indice {i}:");
            ...
            for(int i = 0;i < 4; i++)
            {
                Console.WriteLine($"El vector caracter, en la posicion {i + 1}, tiene almacenado el dato: {caracter[2]}");
